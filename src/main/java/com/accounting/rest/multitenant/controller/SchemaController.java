...
public class SchemaController {
	...
	public ResponseEntity<String> createSchema() {
		try {
			...
			return ResponseEntity.ok("Schema created/updated successfully.");
		} catch (Exception e) {
			return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Schema creation/update failed." + e);
		}
	}
}