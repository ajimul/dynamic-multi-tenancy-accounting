...
import com.accounting.rest.multitenant.dto.SalesModel;
...
public class SalesController {
	...
	@Autowired
	public SalesController(FolioNumberServices folioNumberServices, AccountsTypeServices accountsTypeServices,
	...
	@PostMapping("/add")
	public ResponseEntity<String> addBooks(@RequestBody SalesModel books) {
