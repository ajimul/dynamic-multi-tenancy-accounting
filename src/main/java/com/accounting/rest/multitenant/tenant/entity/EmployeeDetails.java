...
public class EmployeeDetails {
	...
	@SequenceGenerator(name = "sequence_generator", sequenceName = "SequenceGenerator_partyDetails", allocationSize = 1)
	...
	public EmployeeDetails(Long empDetailsId, Long emp_ac_refId, String empContactNo1, String empContactNo2,
			String empEmailId, String empGstNo, String empBillingAddress, String empShipingAddress,
			Long empOpeningBalance, String empAreaCode, LocalDate empDob, String empBloodGroup,
			String empJobeDesignation, LocalDate empJoiningDate, String empSalaryPackage, String empAadharNo,
			String empPanNo) {
		super();
